...
#include "my_diffbot/diffbot_system.hpp"
...
hardware_interface::return_type my_diffbot ::DiffBotSystemHardware::write(
  const rclcpp::Time & /*time*/, const rclcpp::Duration & /*period*/)
{
  // BEGIN: This part here is for exemplary purposes - Please do not copy to your production code
  std::stringstream ss;
...
PLUGINLIB_EXPORT_CLASS(
  my_diffbot::DiffBotSystemHardware, hardware_interface::SystemInterface)
